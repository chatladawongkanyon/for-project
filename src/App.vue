        ...
        <div class="flex flex-col pl-14">
          <div class="form-control w-52">
            <label class="cursor-pointer label">
              ...
              <input type="checkbox" v-model="test1led1" class="toggle toggle-accent" @change="ledToggle('TEST1/LED1', ($event.target as any).checked)" unchecked />
            </label>
          </div>
          <div class="form-control w-52">
            <label class="cursor-pointer label">
              <span class="label-text">LED2</span>
              <input type="checkbox" v-model="test1led2" class="toggle toggle-accent" @change="ledToggle('TEST1/LED2', ($event.target as any).checked)" unchecked />
            </label>
          </div>
        </div>
      ...
      <div class="card-body">
        ...
        <div class="flex flex-col pl-14">
          <div class="form-control w-52">
            <label class="cursor-pointer label">
              <span class="label-text">LED1</span>
              <input type="checkbox" v-model="test2led1" class="toggle toggle-accent" @change="ledToggle('TEST2/LED1', ($event.target as any).checked)" unchecked />
            </label>
          </div>
          <div class="form-control w-52">
            <label class="cursor-pointer label">
              <span class="label-text">LED2</span>
              <input type="checkbox" v-model="test2led2" class="toggle toggle-accent" @change="ledToggle('TEST2/LED2', ($event.target as any).checked)" unchecked />
            </label>
          </div>
        </div>
        <div class="card-actions justify-end"></div>
...
<style scoped>
/* Omit the logo styles as they are not relevant to the checkbox functionality */
</style>